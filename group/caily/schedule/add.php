	...
	<table class="form" cellspacing="0">
		<tr><th>日付<span class="necessary">(必須)</span></th><td>
			<div id="default"<?=$view->style($hash['data']['schedule_type'], 0)?>>
				<select name="schedule_year"><?=$helper->option(2000, 2030, $hash['data']['schedule_year'])?></select>年&nbsp;
			...
			<div id="repeat"<?=$view->style($hash['data']['schedule_type'], 1)?>>
				...
				繰り返し期間：&nbsp;<select name="beginyear"><?=$helper->option(2000, 2030, $hash['data']['beginyear'])?></select>年&nbsp;
