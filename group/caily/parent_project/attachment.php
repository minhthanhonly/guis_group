...
$view->heading('建物添付ファイル');

// Get parent project ID from URL
...
<div id="app" class="container-fluid mt-4" v-cloak>
    ...
    <div v-if="canViewProject">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="parentProjectNavbar">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link" href="detail.php?id=<?php echo $parent_project_id; ?>">建物詳細</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="attachment.php?id=<?php echo $parent_project_id; ?>">添付ファイル</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="row">
            <!-- Back button -->
            <div class="col-12 mb-3">
                <a href="detail.php?id=<?php echo $parent_project_id; ?>" class="btn btn-outline-primary">
                    <i class="fa fa-arrow-left me-2"></i><span data-i18n="建物詳細へ戻る">建物詳細へ戻る</span>
                </a>
            </div>
...
<script src="assets/js/parent-project-attachment.js?v=<?=CACHE_VERSION?>"></script> 
