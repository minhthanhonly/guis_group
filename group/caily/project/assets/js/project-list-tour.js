...
(function () {
    ...
    var COPY = {
        ja: {
            ...
            keepOnResetTitle: 'リセット時にチーム／会社を保持',
            keepOnResetText: 'ONにすると、リセットしてもチームや会社の選択が残ります。同じチーム／会社で何度も絞り込み直すときに便利です。',
            columnsTitle: '列の表示',
        ...
        vi: {
            ...
            keepOnResetTitle: 'Giữ team / công ty khi Reset',
            keepOnResetText: 'Bật công tắc này để khi Reset vẫn giữ lựa chọn team hoặc công ty. Hữu ích khi bạn thường lọc lại cùng một team/công ty.',
    ...
    function createTour() {
        ...
        var steps = [
            ...
            },
            {
                ...
                attachSelectors: ['#projectFilterKeepOnResetTourTarget', '#filterKeepTeamOnReset', '#filterKeepCompanyOnReset'],
                attachOn: 'top',
                showSkip: true,
                showBack: true,
                needsFilterOpen: true
