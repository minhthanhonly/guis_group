...
<div class="container-xxl flex-grow-1 container-p-y">
	...
	<div class="card" id="option-block">
		<div class="card-header bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
			<div class="col-md-6">
				<h4 class="card-title mb-0"><span id="timecard_title">アドレス編集</h4>
            </div>
			<div class="col-md-6 d-flex justify-content-end gap-4">
				...
				<div><a href="add.php?id=<?=$hash['data']['id']?>" class="btn btn-primary">複製</a></div>
...
<form class="content mt-12 mb-12" method="post" name="addressbook" action="">
	...
	<div class="row">
		<div class="col-12">
			...
			<div class="mb-3 row">
				...
				<div class="col-md-6">
					<input type="text" name="addressbook_url" class="form-control" value="<?=$hash['data']['addressbook_url']?>" />
				</div>
			</div>
			<div class="mb-3 row">
	...
	<div class="submit">
		...
		<a href="index.php<?=$view->positive(array('folder'=>$hash['data']['folder_id']))?>" class="btn btn-secondary">キャンセル</a>
	</div>
